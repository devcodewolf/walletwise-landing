          ...
          <div style={{ display: 'flex', gap: 3, alignItems: 'flex-end', height: 100, width: '100%', justifyContent: 'center' }}>
            ...
            <div
              style={{
                ...
                transition: 'height 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.15s',
              }}
            />
          </div>
...
export default function AppPreview() {
  ...
  const countUpIncome = useCountUp(2450, 1200, active);
  const countUpExpense = useCountUp(1320.5, 1400, active);
  const countUpBalance = useCountUp(1129.5, 1600, active);

  const borderColor = isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.08)';
  const surfaceBg = isDark ? 'rgba(255,255,255,0.025)' : 'rgba(0,0,0,0.02)';

  return (
    <section className="app-preview-section" aria-label="Vista previa del dashboard de WalletWise" style={{ padding: '4rem 1.5rem 6rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: isDark ? '0 0 60px rgba(52,211,153,0.04), 0 0 120px rgba(6,182,212,0.02)' : '0 4px 24px rgba(0,0,0,0.06)',
            transition: 'all 0.3s',
            minHeight: 440,
          }}
        >
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', fontFamily: 'var(--font-mono)' }}>Buscar transacciones...</span>
              </div>
              <div
                style={{
                  width: 32,
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                    <span style={{ fontSize: '0.7rem', fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: 'var(--font-mono)' }}>
                      Ingresos vs Gastos
                    </span>
                    <span style={{ width: 8, height: 8, borderRadius: 2, background: 'var(--color-chart-bar)' }} />
                    <span style={{ fontSize: '0.6rem', color: 'var(--color-text-muted)' }}>Ing</span>
                    <span style={{ width: 8, height: 8, borderRadius: 2, background: 'var(--color-chart-bar-alt)' }} />
                ...
                >
                  <div style={{ fontSize: '0.7rem', fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: 'var(--font-mono)', marginBottom: 14 }}>
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 36,
                            borderRadius: 10,
                            background: tx.type === 'income' ? 'color-mix(in srgb, var(--color-accent) 12%, transparent)' : 'color-mix(in srgb, #ef4444 12%, transparent)',
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontSize: '0.8rem', fontWeight: 500, color: 'var(--color-text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                            {tx.desc}
                          </div>
...
function MetricCard({ label, value, prefix, color }: { label: string; value: number; prefix: string; color: string }) {
  return (
    ...
    >
      <div style={{ fontSize: '0.68rem', color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: 'var(--font-mono)', marginBottom: 4 }}>
        {label}
      </div>
      <div style={{ fontSize: '1.2rem', fontWeight: 700, fontFamily: 'var(--font-mono)', color, letterSpacing: '-0.02em' }}>
